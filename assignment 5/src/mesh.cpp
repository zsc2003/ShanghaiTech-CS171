  ...
  if (mesh_primitive == MeshPrimitiveType::cube) {
    ...
    for (int i = 0; i < primitive_sphere_resolution; ++i) {
      ...
      for (int j = 0; j < primitive_sphere_resolution; ++j, ++k1, ++k2) {
        ...
        vertices.emplace_back(MeshVertex(n * Float(1.0), n, Vec2(s, t)));
...
/*virtual*/ void Mesh::FixedUpdate(Vec3 mouse, bool left, bool middle) { }
/*virtual*/ bool Mesh::DragUpdate(Vec3 mouse, Vec3 CameraPos) {return false; }
/*virtual*/ void Mesh::move_fix(Vec3 mouse, bool mid, Vec3 CameraPos) { }
