...
class Mesh {
 public:
  static constexpr unsigned primitive_sphere_resolution = 16;//change the discrate point
  ...
  virtual void FixedUpdate(Vec3 mouse, bool left, bool middle);

  virtual bool DragUpdate(Vec3 mouse, Vec3 CameraPos);
  virtual void move_fix(Vec3 mouse, bool mid, Vec3 CameraPos);
